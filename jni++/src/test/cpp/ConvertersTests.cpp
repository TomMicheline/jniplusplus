...
TEST_F(JvmTestFixture, ConvertCppToJavaTest)
{
    ...
    jobject javaStringValue = ToJavaConverter<std::string>::convertToJava(TEST_STRING);
    ...
    jshort javaShortValue = ToJavaConverter<short>::convertToJava(kTestShort);
    ...
    jchar javaCharValue = ToJavaConverter<char>::convertToJava(kTestChar);
    ...
    jint javaIntValue = ToJavaConverter<int>::convertToJava(kTestInt);
    ...
    jlong javaLongValue = ToJavaConverter<long>::convertToJava(kTestLong);
    ...
    jfloat javaFloatValue = ToJavaConverter<float>::convertToJava(kTestFloat);
    ...
    jdouble javaDoubleValue = ToJavaConverter<double>::convertToJava(kTestDouble);
